...
const TEMPLATE_KEYS = [
    ...
    { id: "password_reset", label: "Password Reset", vars: ["user", "resetLink"] },
    { id: "comic_available", label: "Comic Available", vars: ["title", "requester", "imageUrl", "description", "date"] },
    { id: "request_approved", label: "Request Approved", vars: ["user", "title", "requester", "imageUrl", "description", "date"] },
    { id: "pending_request", label: "Pending Request", vars: ["user", "title", "requester", "imageUrl", "description", "date"] },
