...
// Pages are extracted with the identical list/filter/sort as the reader and the OPDS page streamer,
// so indexes always line up. CBR/RAR can't be page-listed (zip-only) — the UI falls back to the
// existing single-page archive-cover for those.
...
export async function GET(req: NextRequest) {
    ...
    try {
        ...
        // Identical list/filter/sort to the OPDS page route, serving original bytes.
