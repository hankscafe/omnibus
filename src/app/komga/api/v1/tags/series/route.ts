// src/app/komga/api/v1/tags/series/route.ts — #206 Komga facade: the "tags" tag section on
// Paperback's homepage. Distinct values of Series.tags across the series the caller can see.
...
export async function GET(req: Request) {
    return komgaGuard('tags/series', async () => {
        ...
        for (const r of rows) for (const t of parseJsonList(r.tags)) distinct.add(t);
