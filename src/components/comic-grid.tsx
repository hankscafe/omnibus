        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
          {comics.map((comic) => {
            ...
            >
                ...
                {/* 1. Base Darkening Layer (Dims the image on hover for contrast) */}
                ...
                {/* 2. Text Overlay (Renders above the dimming layer so text is crisp) */}
                ...
                {/* 3. Button Overlay (Renders on TOP of everything so it never washes out) */}
