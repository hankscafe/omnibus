...
export function TitleManager() {
  ...
  useEffect(() => {
    ...
    else if (pathname.startsWith("/admin/email-templates")) newTitle = "Omnibus - Email Templates";
    ...
    else if (pathname.startsWith("/library/updates")) newTitle = "Omnibus - Updates";
